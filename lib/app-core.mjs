...
export const referenceAssets = {
  ...
  ogp: {
    fileId: "1VcYSpJjEhlttOuef_twMynR8Rb2tmj8W",
    fallbackPath: join(publicDir, "assets", "ogp.png"),
    filename: "ogp.png",
    mimeType: "image/png"
  },
  "app-icon": {
    fileId: "1jpVtssetay35KJziGqcIFrAZtHrUfhbc",
    fallbackPath: join(publicDir, "assets", "app-icon.png"),
